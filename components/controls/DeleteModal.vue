<template lang="pug">
.fixed.bottom-0.inset-x-0.px-4.pb-4(v-bind:x-data="'{ open:' + isOpen + '}'" x-show="open" class="sm:inset-0 sm:flex sm:items-center sm:justify-center")
