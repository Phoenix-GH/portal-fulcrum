...
.mt-1.rounded-md.shadow-sm
  .mt-1.relative.rounded-md.shadow-sm    
    ...
    .absolute.inset-y-0.right-0.pr-2.flex.items-center
      a.text-xs.tracking-wider.py-1.px-2.rounded-sm.uppercase.font-semibold.text-indigo-700.bg-indigo-50.w-14.text-center(href="" @click.prevent="toggle" class="hover:bg-indigo-100") {{ hidden ? 'show' : 'hide' }}
