          ...
          div
            ...
            .mt-6.grid.grid-cols-1.row-gap-6.col-gap-4(class="sm:grid-cols-6")
              div(class="sm:col-span-4")
                ...
                .mt-1.flex.rounded-md.shadow-sm: input#teamname.flex-1.form-input.block.w-full.rounded.transition.duration-150.ease-in-out(v-model="team_name" class="sm:text-sm sm:leading-5")
